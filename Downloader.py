# AudioCaps downloader from https://github.com/MorenoLaQuatra/audiocaps-download/blob/main/audiocaps_download/Downloader.py
...
class Downloader:
    ...
    def download(
        ...
        # parallel + tqdm
        joblib.Parallel(n_jobs=self.n_jobs, verbose=10, backend='multiprocessing')(
    ...
    # idk why the valset didn't download?????
    def download_valset_and_cross_check(self, format='flac', quality=5):
        t1 = time.time()
